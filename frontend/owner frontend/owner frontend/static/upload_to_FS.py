...
#     #Ideally, camera type will be retreived from database, but to save time, passing it here
#     
#     If camera_type==entry:
#         if nplate not already in property's realtime cars list:
#             put new object in cars list :
#                 nplate = nplate
#                 entry camera name = camera_name
#                 entry_timestamp = timestamp
#                 exit_camera_name = None
#                 exit_timestamp = None

#             put in realtime cars list:
#                 nplate
    
#     If camera_type==exit:
#          if nplate in property's realtime cars list:
#             find the latest entry_timestamp of car with nplate (sort)
#             update these in that entry:
#                 exit_camera_name = camera_name
#                 exit_timestamp = timestamp
                
#             remove from realtime cars list:
#                 nplate
